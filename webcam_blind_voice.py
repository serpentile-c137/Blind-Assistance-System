...
# === Tesseract for macOS (adjust path if using Linux/Windows) ===
...
# === Track last spoken frame per object ===
        ...
        while True:
            ...
            for i in range(min(10, boxes.shape[0])):
                ...
                if class_id in [1, 3, 6, 8, 44] and distance_cm <= 50 and 0.3 < mid_x < 0.7:
                    warning = f"Warning - {object_name} very close to you"
                    print(warning)
                    engine.say(warning)
